            ...
            switch (args.operation) {
              case "createDraft": {
                if (typeof args.isReply !== 'boolean' || !args.subject || !args.body) {
                  throw new Error("isReply, subject, and body are required for createDraft operation.");
                }
              ...
              case "read": {
                ...
                if (email) {
                  ...
                  return {
                    content: [{ type: "text", text: `Could not find or read email with ID: ${args.messageId}` }],
                    isError: true
                  };
                }
              }
              case "move": {
                if (!args.messageId || !args.targetMailboxName) {
                  throw new Error("messageId and targetMailboxName are required for move operation.");
                }
                const result = await mailModule.moveEmail(args.messageId, args.targetMailboxName, args.targetAccountName);
                return {
                  content: [{ type: "text", text: result.message }],
                  isError: !result.success
                };
              ...
              case "listMailboxes": {
                const mailboxes = await mailModule.listMailboxes(args.accountName);
                return {
                  content: [{
                    type: "text",
                    text: mailboxes.length > 0 ?
                      `Found ${mailboxes.length} mailbox(es)${args.accountName ? ` for account "${args.accountName}"` : ''}:\n\n${mailboxes.join("\n")}` :
                      `No mailboxes found${args.accountName ? ` for account "${args.accountName}"` : '.'}`
                  }],
                  isError: false
                };
              }
...
type MailArgs = 
  | { operation: "createDraft"; isReply: boolean; originalMessageId?: string; toAddress?: string; subject: string; body: string; attachmentPath?: string; searchTerm?: never; limit?: never; messageId?: never; targetMailboxName?: never; targetAccountName?: never; accountName?: never; mailboxName?: never; isRead?: never; isFlagged?: never; }
  | { operation: "list"; searchTerm?: string; limit?: number; accountName?: string; mailboxName?: string; isRead?: boolean; isFlagged?: boolean; isReply?: never; originalMessageId?: never; toAddress?: never; subject?: never; body?: never; attachmentPath?: never; messageId?: never; targetMailboxName?: never; targetAccountName?: never; }
  | { operation: "read"; messageId: string; searchTerm?: never; limit?: never; isReply?: never; originalMessageId?: never; toAddress?: never; subject?: never; body?: never; attachmentPath?: never; targetMailboxName?: never; targetAccountName?: never; accountName?: never; mailboxName?: never; isRead?: never; isFlagged?: never; }
  | { operation: "move"; messageId: string; targetMailboxName: string; targetAccountName?: string; searchTerm?: never; limit?: never; isReply?: never; originalMessageId?: never; toAddress?: never; subject?: never; body?: never; attachmentPath?: never; accountName?: never; mailboxName?: never; isRead?: never; isFlagged?: never; }
  | { operation: "listMailboxes"; accountName?: string; searchTerm?: never; limit?: never; isReply?: never; originalMessageId?: never; toAddress?: never; subject?: never; body?: never; attachmentPath?: never; messageId?: never; targetMailboxName?: never; targetAccountName?: never; mailboxName?: never; isRead?: never; isFlagged?: never; };
...
function isMailArgs(args: unknown): args is MailArgs {
  ...
  switch (operation) {
    case "createDraft":
      ...
      if (typeof isReply !== 'boolean' || typeof subject !== 'string' || typeof body !== 'string') return false;
      if (isReply && typeof (args as MailArgs & { operation: "createDraft" }).originalMessageId !== 'string') return false;
      break;
    case "list":
      const { searchTerm, limit, accountName, mailboxName, isRead, isFlagged } = args as MailArgs & { operation: "list" };
    ...
    case "read":
      ...
      const { accountName: listMbAccountName } = args as MailArgs & { operation: "listMailboxes" }; // Renamed to avoid conflict
      if (listMbAccountName && typeof listMbAccountName !== "string") return false;
      break;
    default:
      return false; 
  }
